...
const Register = () => {
    ...
    const { createUser, googleLogin, twitterLogin , facebookLogin} = useAuth();
                ...
                <div className="flex flex-col gap-2 justify-center text-center">
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col text-start gap-5">
                        ...
                        <div className="w-full">
                            ...
                            <input {...register("name", { required: true })} name="name" type="text" placeholder="Type Here Your Name" className="input input-bordered w-96" />
                        ...
                        <button className="w-full btn bg-[#D1A054B3] text-white">Sign Up</button>
                    </form>
                    <p className="text-[#D1A054]">Have an Account? <Link className="font-bold" to="/login">Sign In Now</Link></p>
                    <p className="text-[#444444]">Or Sign In With</p>
                    <div className="flex justify-center gap-5 mt-2">
                        <div onClick={handleFacebookLogin} className="p-3 cursor-pointer text-[#444444] text-2xl bg-transparent border rounded-full border-[#444444]">
                            <FaFacebookF />
                        </div>
                        <div onClick={handleGoogleLogin} className="p-3 cursor-pointer text-[#444444] text-2xl bg-transparent border rounded-full border-[#444444]">
                            <FaGoogle />
                        </div>
                        <div onClick={handleTwitterLogin} className="p-3 cursor-pointer text-[#444444] text-2xl bg-transparent border rounded-full border-[#444444]">
                            <FaTwitter />
                        </div>
                    </div>
                </div>
